...
github_version = html[index + 11:index + 16]
...
html = str(
    requests.get(
        'https://oplab9.parqtec.unicamp.br/pub/ppc64el/containerd/'
    ).content)
index = html.rfind('containerd-')
ftp_version = html[index + 11:index + 16]
